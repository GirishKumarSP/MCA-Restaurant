    ...
    return (
        ...
        >
            ...
            <div className="bg-gray-600 p-6 rounded-lg z-10 w-3/6">
                ...
                <select className="w-full p-2 border border-gray-300 rounded-lg mb-4 bg-gray-700 text-white" type="time" id="res-time" value={Order.time} name='etime' onChange={onchange} required>
                ...
                <p className="text-black font-bold text-base mb-4">Occasion</p>
                                <select className="w-full p-2 border border-gray-300 rounded-lg mb-4 bg-gray-700 text-white" type="time" id="res-time" value={Order.eoccasion} name='eoccasion' onChange={onchange} required>
