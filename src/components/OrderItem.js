        ...
        <div>
            <div className='m-3'>
                <div className="p-6 bg-gray-800 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <p className="mb-2 mr-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Order No:</p>
                    ...
                    <p className="font-normal text-gray-700 dark:text-gray-400">{order.orderDetails.total}</p>
                </div>
            </div>
        </div>
    )
